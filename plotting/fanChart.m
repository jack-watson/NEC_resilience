function [lh, ph, col] = fanChart(xvals, paths, centerType, prctiles, varargin)

% Published on FileExchange by Ameya Deoras
% 1 September 2016, Version 1.1.0.1

% FileExchange "Cite As" copypaste:
% "Ameya Deoras (2025). Fanchart - Visualize percentiles of time series data 
% (https://www.mathworks.com/matlabcentral/fileexchange/48006-fanchart-visualize-percentiles-of-time-series-data), 
...
for i = 1:ncolors
    ph(i) = patch(xplot, [bands(:,0+i);  flipud(bands(:,end-i+1))]', col(i,:) ,'EdgeColor', col(i,:), 'Parent', parent, 'FaceAlpha', alpha, 'EdgeAlpha', 0);
end
